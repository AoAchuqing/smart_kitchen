...
def main():
    ...
    col1.image("https://image.flaticon.com/icons/png/512/3135/3135715.png",width = 50)
    ...
    if app_mode == statistics_page:
        app_statistics()
    elif app_mode == dashboard_page:
        app_dashboard()
    elif app_mode == algorithm_page:
        app_algorithm()
    elif app_mode == knowledge_base_page:
        app_knowledge_base()
    elif app_mode == employee_page:
        app_employee()
